...
function open_flash_chart_object_str( $width, $height, $url, $use_swfobject=true, $base='vn/' )
{
    //
...
function open_flash_chart_object( $width, $height, $url, $use_swfobject=true, $base='vn/' )
{
    //
