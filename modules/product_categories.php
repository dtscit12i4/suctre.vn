...
{
    ?>
    <meta http-equiv="refresh" content="0;URL=/du-an-bat-dong-san/"/>
    <?
}
}
?>
    ...
    <div class="row">
    	...
    	<div class="col-sm-9 col-xs-12 project-right">
    		<div class="block-home-title">
    			<h1 class="h1-project"><a style="color: #2c2e83;" href="<?=$root?>du-an-bat-dong-san/" title="Dự án">Dự án</a></h1>
    		</div>
    		<div class="clearfix"></div>
    	<?
    		$sql="select * from $tbl_product where visibility=1 and display=1 order by sort";
    	...
    	?>
    		...
    		<div class="col-sm-7">
    			...
    			<div class="view-more-project">
	                <p class="line-more"></p>
	                <p class="text-right"><a style="color:#e2b600;" href="<?=$url->product($row['id'])?>" title="Xem thêm">Chi tiết <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></a></p>
            </div>
    		</div> 
    		</div>
    	<?} }?>
			<div class="paging col-md-12">
                <?=showpage($page,$pages,$root.'du-an-bat-dong-san/');?>                        
            </div>
    	</div>
    </div>
</div>
